...
function App() {
  ...
  return (
      ...
      <div className="font-Clash z-0 relative h-screen overflow-y-scroll bg-[#150E28] w-screen">
       ...
       <div className="absolute md:hidden bg-mobilepurpleLens w-[24.75rem] left-[-0.875rem] h-[27.63rem] bg-origin-border bg-getlink z-[-1] bg-blend-hard-light bg-no-repeat "></div>
        <header className="flex w-full items-center sticky z-50 bg-getlink top-0 left-0 right-0 justify-between pt-3 h-[4.3rem] px-[3rem] md:h-[106px] border-b border-gray-800">        
          ...
          <nav className="hidden md:block text-white text-[13px] mt-[47px] font-Montserrat mr-[96px] h-fit w-[547px] ">
            <ul className="inline-flex justify-between w-[315px] list-none items-center">
              ...
              <Link to={'/#'}><li className="ml-[44px]">Overview</li></Link>
              <Link to={'/#'}><li className="ml-[44px]">FAQs</li></Link>
              <Link to={'/contact'}><li className="ml-[44px]">Contact</li></Link>
            </ul>
        ...
        <main className="text-white box-border overflow-x-hidden -z-[2] w-screen ">
          <div id='block1' className="flex items-center justify-start  relative md:flex-row md:items-start overflow-hidden w-full flex-col border-b border-b-[#ffffff2f] ">
              ...
              <div className='mt-10 flex md:justify-center justify-start flex-col w-screen md:items-start items-center leading-[1.2]'>
                <p className='relative font-bold text-[2rem]' >
                  ...
                  <img className="absolute w-[0.375rem] h-[0.5rem] bottom-[3.125rem] -right-[0.812rem]" src="/gray-mini-star.png" alt="grey-mini-star"/>
                    ...
                    <Link to={'/register'}><button className="rounded-md px-[2.88rem] mt-[1.8rem] pt-[0.876rem] pb-[0.937rem] text-[0.875rem] bg-gradient-to-r from-gradient1 to-gradient2 relative">Register 
...
{/* 
           ...
           <div id='block2/3' className="flex flex-col md:flex-row md:gap-[3.83rem] pb-[3rem] border-b border-gray-500 justify-between items-center relative overflow-hidden w-full pt-8 border-b-[#ffffff2f] ">
            <div id='b2-left/top' className="w-fit relative  mb-[3.83rem]">
            ...
            <div id='b2-right/bottom' className="relative flex justify-start items-center flex-col">
              ...
              <p className="text-[0.82rem] pb-[5rem] px-10 text-center border-b border-gray-600 font-Montserrat font-light leading-[1.72rem] mt-3">
                {`Our tech hackathon is a melting pot of visionaries, and its purpose is as clear as day: to shape the future. Whether you're a coding genius, a  design maverick, or a concept wizard, you'll have the chance to transform  your ideas into reality. Solving real-world problems, pushing the boundaries of technology, and creating solutions that can change the world, that's what we're all about!`}</p>
            </div>

        
          <div className="absolute md:hidden bg-rightMobilepurpleLens w-[12.8rem] top-[69rem] -translate-y-1/2 -right-4 h-[23.33rem] bg-origin-border bg-getlink z-[-1] bg-blend-hard-light bg-no-repeat "></div>
          <div className="absolute md:hidden bg-mobilepurpleLens top-[45.25rem] -translate-y-14 w-[24.75rem] left-[-0.875rem] h-[27.63rem] bg-origin-border bg-getlink z-[-2] bg-blend-hard-light bg-no-repeat "></div>
            ...
            <div id='b3-right' className="w-fit relative mb-2">
              <img className="absolute  w-[0.625rem] h-[0.75rem] top-[11.56rem] -left-[0.31rem]" src="/white-mini-star.png" alt="white-mini-star"/>
              <figure className="relative w-[18.38rem] sm:w-[41.5rem] h-[23.88rem] sm:h-[41.5rem]">
                  <img className=" hidden sm:inline-block w-full h-full" src="/tablady.png"  />
                  <img className=" sm:hidden w-full h-full" src="/m-tablady.png"  />
              </figure>
            </div>
          ...
          <div className="absolute md:hidden bg-rightMobilepurpleLens w-[12.8rem] top-[58rem] -translate-y-1/2 -right-4 h-[23.33rem] bg-origin-border bg-getlink z-[-1] bg-blend-hard-light bg-no-repeat "></div>
          <div className="absolute md:hidden bg-mobilepurpleLens top-[9.5rem] -translate-y-14 w-[24.75rem] left-[-0.875rem] h-[27.63rem] bg-origin-border bg-getlink z-[-2] bg-blend-hard-light bg-no-repeat "></div>
              ...
              <p className="text-[24px] text-center leading-[133%] p-0 inline-block font-[700]">
                ...
                <span className="text-getlink3"> Key attributes</span>
                  ...
                  <div className='flex justify-start items-center flex-col'>
                    <p className="text-[0.75rem] text-center font-Montserrat font-[300] w-[394px] mb-2 px-10 mt-4">
          ...
          <div id='block7' className="flex flex-col md:flex-row gap-[3.83rem] pb-[5.7rem] border-b border-gray-500 justify-between items-center relative overflow-hidden w-full pt-[4.5rem] border-b-[#ffffff2f] ">
           ...
           <div className="absolute md:hidden bg-rightMobilepurpleLens w-[14.5rem] bottom-0 translate-y-1/3 -right-7 h-[23.33rem] bg-origin-border bg-getlink z-[-1] bg-blend-hard-light bg-no-repeat "></div>
              ...
              <div className=' py-7 px-10 border relative border-getlink3 rounded-lg'>
            ...
            <div id='block9' className="flex backdrop-opacity-50 flex-col md:flex-row gap-[3.83rem] pb-[5.7rem] border-b border-gray-500 justify-between items-center relative overflow-hidden w-full pt-[4.44rem] border-b-[#ffffff2f] ">
            <div className="absolute md:hidden bg-leftMobilepurpleLens w-[17.85rem] top-[35rem] left-0 h-[22.93rem] bg-origin-border bg-getlink z-[-1] bg-blend-hard-light bg-no-repeat "></div>
            <div className="absolute md:hidden bg-rightMobilepurpleLens w-[14.5rem] top-0 -translate-y-2/3 -right-7 h-[23.33rem] bg-origin-border bg-getlink z-[-1] bg-blend-hard-light bg-no-repeat "></div>
            ...
            <div id='block10' className="flex flex-col md:flex-row gap-[3.83rem] pb-[3.314rem] border-b border-gray-500 justify-between items-center relative overflow-hidden w-full pt-[3.188rem] border-b-[#ffffff2f] px-16  ">
              ...
              <p className='font-normal font-Montserrat mb-3 relative '>All rights reserved. © getlinked Ltd.
